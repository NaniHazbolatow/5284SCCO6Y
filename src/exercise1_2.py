...
def plot_heatmap(test_time, N, dt, dx, D):
    ...
    plt.title(f'Diffusion at t = {test_time[0]}', fontsize=17)
    plt.tick_params(axis='both', labelsize=13)
    ...
    plt.xlabel('x', fontsize=17)
    plt.title(f'Diffusion at t = {test_time[1]}', fontsize=17)
    plt.tick_params(axis='both', labelsize=13)
    cbar = plt.colorbar(label='Concentration')
    cbar.ax.tick_params(labelsize=14)
    cbar.set_label('Concentration', fontsize=16)
    ...
    plt.xlabel('x', fontsize=17)
    plt.title(f'Diffusion at t = {test_time[2]}', fontsize=17)
    plt.tick_params(axis='both', labelsize=13)
    cbar = plt.colorbar(label='Concentration')
    cbar.ax.tick_params(labelsize=14)
    cbar.set_label('Concentration', fontsize=16)
